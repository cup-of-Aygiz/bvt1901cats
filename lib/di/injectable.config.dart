...
import '../features/basket/data/network_basket_repository.dart' as _i29;
import '../features/basket/domain/basket_repository.dart' as _i28;
...
import '../features/login/data/auth_secure_storage.dart' as _i27;
...
import '../features/orders/data/network_orders_repository.dart' as _i17;
import '../features/orders/domain/orders_repository.dart' as _i16;
...
import '../features/products_catalog/data/catalog_network_repository.dart'
    as _i31;
import '../features/products_catalog/domain/catalog_repository.dart' as _i30;
...
import '../features/registration/domain/repository/registration_repository.dart'
    as _i22;
import '../features/search/data/searcher_network_repository.dart' as _i25;
import '../features/search/domain/searcher_repository.dart' as _i24;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i16.OrderRepository>(
      () => _i17.NetworkOrdersRepository(get<_i8.DioContainer>()));
  gh.factory<_i18.PersonRepository>(
      () => _i19.PersonNetworkRepository(get<_i8.DioContainer>()));
  gh.factory<_i20.ProductDetailsRepository>(
      () => _i21.ProductDetailsNetworkRepository(get<_i8.DioContainer>()));
  gh.factory<_i22.RegistrationRepository>(
      () => _i23.RegistrationNetworkRepository(get<_i8.DioContainer>()));
  gh.factory<_i24.SearcherRepository>(
      () => _i25.SearcherNetworkRepository(get<_i8.DioContainer>()));
  await gh.factoryAsync<_i26.SharedPreferences>(
      () => registerModule.sharedPreferences,
      preResolve: true);
  gh.factory<_i27.AuthTokenStorage>(
      () => _i27.AuthTokenLocalStorage(get<_i12.FlutterSecureStorage>()));
  gh.factory<_i28.BasketRepository>(
      () => _i29.BasketNetworkRepository(get<_i8.DioContainer>()));
  gh.factory<_i30.CatalogRepository>(
      () => _i31.CatalogNetworkRepository(get<_i8.DioContainer>()));
  return get;
}

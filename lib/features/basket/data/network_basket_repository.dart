...
class BasketNetworkRepository extends BasketRepository {
  ...
  Future<List<ProductEntity>> deleteFromProductList({required int productId}) {
    // TODO: implement deleteFromProductList
    throw UnimplementedError();
  }
  ...
  Future<List<ProductEntity>> getProductList() async {
    ...
    try {
      ...
      dioContainer.dio.options.headers['x-access-token'] = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NCwiaWF0IjoxNjUyODA1OTQ1LCJleHAiOjE2NTI4OTIzNDV9.-woAjIs6c9NXjPZ-CT7zdqxC6jRdEKHS8BDFV6mJJ3w';
  ...
  Future<List<ProductEntity>> updateProductList(
    ...
    // TODO: implement updateProductList
    throw UnimplementedError();
  }
}
